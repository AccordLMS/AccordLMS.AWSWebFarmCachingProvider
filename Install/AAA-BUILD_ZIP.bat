...
"%ProgramFiles%\WinRAR\winrar.exe" M -afzip -m5 -r -ep1 _tempzip\AccordLMS.01.00.01.AWSWebFarmCachingProvider_Install.zip _tempzip\*.*

COPY _tempzip\AccordLMS.01.00.01.AWSWebFarmCachingProvider_Install.zip .\*.*
